...
export default function StockAdjustmentModal({ visible, productId, onClose, onSuccess }: StockAdjustmentModalProps) {
  ...
  // 🟢 Get device safe area to prevent bottom cutting
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      {/* 🟢 Fix: Platform specific keyboard behavior prevents squashing */}
      <KeyboardAvoidingView 
      ...
      >
        <View style={styles.modalBackdrop}>
          ...
          <View style={styles.bottomSheet}>
            ...
            {/* 🟢 Fix: Added keyboardShouldPersistTaps and dynamic bottom padding */}
            <ScrollView 
            ...
            >
              ...
              <View style={styles.segmentContainer}>
                ...
                >
                  ...
                  <ThemedText 
                    style={[styles.segmentText, isAdd && styles.segmentTextActive]}
                    numberOfLines={1} 
                    ...
                    render={({ field: { value } }) => {
                      ...
                      return (
                        <View style={styles.dropdownSim}>
                          <ThemedText style={{ color: selected ? theme.textPrimary : theme.textTertiary, fontFamily: theme.fonts.body, flexShrink: 1 }} numberOfLines={1}>
...
const createStyles = (theme: ThemeColors, insets: any) => StyleSheet.create({
  ...
  bottomSheet: {
    ...
    maxHeight: '92%', // Slightly taller to accommodate smaller screens
  ...
  footer: { 
    ...
    // 🟢 Fix: Dynamic padding based on device insets so it never cuts into the bottom bezel
