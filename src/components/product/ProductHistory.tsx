  ...
  const loadHistory = async (isRefresh = false, filterMode: DateFilter = activeFilter) => {
    ...
    try {
      ...
      if (filterMode === '7days') {
        ...
        startDate = formatDateForApi(past);
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={() => router.navigate(`/product/${id}` as any)} style={styles.backBtn} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
