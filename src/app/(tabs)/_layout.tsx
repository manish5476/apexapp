...
// This context will reliably share the Drawer's navigation object
export const DrawerContext = React.createContext<any>(null);
...
export default function DrawerLayout() {
  ...
  const [drawerNav, setDrawerNav] = React.useState<any>(null);
  const [isDrawerOpen, setIsDrawerOpen] = React.useState(false);

  return (
    <DrawerContext.Provider value={drawerNav}>
      <View style={{ flex: 1, paddingTop: insets.top }}>
        <Drawer
          drawerContent={(props) => (
            <CustomDrawerContent 
              {...props} 
              setDrawerNav={setDrawerNav} 
      ...
      >
        ...
        <FloatingNav 
          onOpenDrawer={() => drawerNav?.dispatch(DrawerActions.openDrawer())} 
